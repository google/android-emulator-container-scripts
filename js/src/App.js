...
import { EmulatorControllerService, RtcrService } from "./components/emulator/net/emulator_web_client";
...
export default class App extends Component {
  constructor(props) {
    ...
    this.rtc = new RtcrService(EMULATOR_GRPC, this.auth, this.onError);
